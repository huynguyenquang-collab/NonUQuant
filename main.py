    ...
    for n, module in tqdm(linears, desc="Quantizing layers"):
        ...
        if method == "rbvt" and n in means:
            ...
            W_out, stats = apply_rbvt(
                ...
                rbvt_rank_alpha=rbvt_rank_alpha,
                row_chunk=row_chunk,
                gap_floor=gap_floor,
...
def build_parser():
    ...
    p.add_argument("--rbvt-rank-alpha", type=float, default=0.0, help="Extra sigma*gap^2 ranking penalty for RBVT candidate ordering")
...
def main():
    ...
    if args.method == "gptvq":
        ...
        model, quant_stats = quantize_model(
            ...
            rbvt_rank_alpha=args.rbvt_rank_alpha,
